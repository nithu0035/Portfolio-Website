...
const AI_RESPONSES = {
  who: "I'm Gudipatoju Nitesh — an AI/ML Engineer from Hyderabad, currently an AI Intern (Foundation Track) at XTRAGRAD Pvt. Ltd., building practical AI systems with RAG, LLMs, and Python.",
  skills: "My stack: Python, Java, SQL, Scikit-learn, XGBoost, Random Forest, LangChain, LangGraph, RAG, ChromaDB, Llama 3.3 70B, Groq API, FastAPI, Flask, PostgreSQL, Docker, Whisper, JWT.",
  projects: "Key projects: AI Chatbot with RAG + Whisper, AI Smart Irrigation System (~90% accuracy), JobPilot agentic job-search assistant, and a Student Placement Prediction Dashboard (~82% accuracy).",
  certificates: "Certified by Google Cloud (Generative AI Studio) and Infosys Springboard (Generative Models for Developers).",
  education: "B.Tech in Artificial Intelligence & Machine Learning at Nalla Malla Reddy Engineering College, Hyderabad — graduated 2026, CGPA 8.0/10.",
  hire: "Nitesh is open to AI/ML Internships and Entry-Level roles. Contact: nithu00035@gmail.com",
  contact: "Email: nithu00035@gmail.com · Phone: +91 8688857245 · LinkedIn: linkedin.com/in/nitesh-gudipatoju",
};
          ...
          <motion.div
            ...
            <div style={{
              ...
              <div style={{ display: "flex", gap: 10 }}>
                {[
                  { label: "LinkedIn", href: "https://www.linkedin.com/in/nitesh-gudipatoju", color: "#0ea5e9" },
