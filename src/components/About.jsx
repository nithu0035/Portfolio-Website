...
export default function About() {
  ...
  const stats = [
    { val:"~90%", label:"Irrigation Model Accuracy" },
    { val:"~82%", label:"Placement Model Accuracy" },
    { val:"4",    label:"AI Projects" },
    { val:"34K+", label:"AI Tryouts Followers" },
  ];

  const cards = [
    { icon:"🎓", title:"AI/ML Engineer", sub:"B.Tech AIML · 2026" },
    { icon:"💼", title:"AI Intern",      sub:"XTRAGRAD · Foundation Track" },
    { icon:"🧠", title:"RAG · LLM",      sub:"LangChain · FastAPI" },
    { icon:"🏆", title:"Certified",      sub:"Google Cloud · Infosys" },
  ];
          ...
          <motion.div
            ...
            <div style={{
              ...
              <p style={{
                ...
                from Hyderabad, currently working as an{" "}
                <span style={{color:"#67e8f9", fontWeight:500}}>AI Intern (Foundation Track) at XTRAGRAD Pvt. Ltd.</span>{" "}
                where I'm building a Computer Vision–based Online Exam Monitoring System with
                real-time alerts and a Flask monitoring dashboard.
              </p>
              <p style={{
                fontFamily:"'Inter', sans-serif",
                ...
                Skilled in end-to-end delivery — RAG pipelines, LLM integration,{" "}
                ...
                <span style={{color:"#a5f3fc"}}>Infosys Springboard</span>. Also run{" "}
                <span style={{color:"#a5f3fc"}}>AI Tryouts</span>, an independent AI &
                technology content platform with 34K+ followers.
              </p>
            </div>
