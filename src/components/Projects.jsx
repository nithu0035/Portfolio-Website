...
const projects = [
  ...
  },
  {
    ...
    tagColor: "#86efac",
    description:
      "Weather-aware crop guidance trained on 10,000+ sensor readings. XGBoost with GridSearchCV outperformed the Random Forest baseline by ~15% via 5-fold cross-validation. PostgreSQL/FastAPI backend, with an IEEE conference contribution.",
    tech: ["Python", "XGBoost", "Random Forest", "GridSearchCV", "PostgreSQL", "FastAPI"],
    link: "https://github.com/nithu0035/smart-irrigation-system-with-weather-aware-crop-guidance",
  },
  {
    title: "JobPilot — Agentic AI Job Assistant",
    emoji: "🧭",
    period: "2026",
    accuracy: "In development",
    // Violet — agentic, workflow, automation
    accent: "#a78bfa",
    glow: "rgba(167,139,250,0.1)",
    border: "rgba(167,139,250,0.2)",
    borderHover: "rgba(167,139,250,0.42)",
    pillBg: "rgba(167,139,250,0.07)",
    pillBorder: "rgba(167,139,250,0.18)",
    pillColor: "#ddd6fe",
    tagBg: "rgba(167,139,250,0.08)",
    tagBorder: "rgba(167,139,250,0.22)",
    tagColor: "#c4b5fd",
    description:
      "Agentic AI job-search assistant with a backend foundation, PostgreSQL persistence, LangGraph-based agent orchestration, tool-calling workflows, and a human-approval step. The agentic workflow is still in active development — no autonomous application submission yet.",
    tech: ["Python", "FastAPI", "Groq API", "Llama 3.3 70B", "PostgreSQL", "LangChain", "LangGraph"],
    link: "https://github.com/nithu0035/jobpilot.git",
  },
  {
    ...
    accuracy: "In development",
    // Teal — vigilance, monitoring, XTRAGRAD internship
    accent: "#2dd4bf",
    glow: "rgba(45,212,191,0.1)",
    border: "rgba(45,212,191,0.2)",
    borderHover: "rgba(45,212,191,0.42)",
    pillBg: "rgba(45,212,191,0.07)",
    pillBorder: "rgba(45,212,191,0.18)",
    pillColor: "#99f6e4",
    tagBg: "rgba(45,212,191,0.08)",
    tagBorder: "rgba(45,212,191,0.22)",
    tagColor: "#5eead4",
    description:
      "Major project for the XTRAGRAD AI Internship (Foundation Track). A computer-vision system for webcam-based online exam monitoring — detecting predefined abnormal activities with real-time alerts, shown on a Flask-based monitoring dashboard. Currently in development.",
...
Practical AI/ML systems — from RAG pipelines and agentic workflows to computer vision and live dashboards
          </p>
        </motion.div>
