...
const certificates = [
  {
    ...
    pillColor: "#bfdbfe",
    file: "genai-cert.pdf.pdf",
  },
  {
    title: "Generative Models for Developers",
    issuer: "Infosys Springboard",
    year: "2025",
    desc: "Practical generative model concepts and developer-focused implementation.",
    skills: ["Generative AI", "Prompt Engineering", "Model Integration"],
    emoji: "📊",
    accent: "#818cf8",
    ...
    pillColor: "#c7d2fe",
    file: "microsoft-cert.pdf.pdf",
  },
  {
    title: "Data Analytics Virtual Experience",
    issuer: "Deloitte",
    year: "Sep–Oct 2025",
    desc: "Job simulation covering forensic data analysis and insight reporting on client-style datasets. Virtual experience, not formal employment.",
    skills: ["Forensic Analytics", "Insight Reporting", "Virtual Experience"],
    emoji: "🔍",
    accent: "#4ade80",
    ...
    pillColor: "#bbf7d0",
    file: "deloitte-cert.pdf.pdf",
  },
  {
    title: "AI/ML Data Analytics Job Simulation",
    issuer: "Tata Group",
    year: "Sep 2025",
    desc: "Job simulation covering applied EDA and AI-based prediction. Virtual experience, not formal employment.",
    skills: ["EDA", "AI Prediction", "Virtual Experience"],
    emoji: "⚡",
    accent: "#fb923c",
    ...
    pillColor: "#fed7aa",
    file: "tata-cert.pdf.pdf",
  },
  {
    title: "Cybrathon 2025 — Certificate of Participation",
    issuer: "Suresh Gyan Vihar University, Jaipur",
    year: "2025",
    desc: "Certificate of participation at Jaipur Cybrathon 2025.",
    skills: ["Hackathon", "Participation"],
    emoji: "🖥️",
    accent: "#2dd4bf",
      ...
      <div className="max-w-6xl mx-auto px-8 md:px-20" style={{ position: "relative", zIndex: 1 }}>
        ...
        <motion.div className="text-center mb-14"
          ...
          <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 13, color: "#a5b4fc", letterSpacing: "0.03em", margin: 0 }}>
            Certifications from Google Cloud & Infosys Springboard · Virtual experiences with Deloitte & Tata Group
          </p>
        </motion.div>
            ...
            <motion.div
              ...
              <div style={{ padding: "32px" }}>
                ...
                {selected.file ? (
                  ...
                  <p style={{ textAlign: "center", fontFamily: "'Inter', sans-serif", fontSize: 12, color: "#64748b" }}>
