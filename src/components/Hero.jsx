...
export default function Hero() {
  ...
  const taglines = [
    "AI/ML Engineer · Generative AI · Python & Backend Engineering",
    "AI Intern @ XTRAGRAD · Foundation Track",
    "RAG · LLM · LangChain · FastAPI · Docker",
        ...
        <motion.div className="md:w-[52%] flex flex-col" style={{ gap:16 }}
          ...
          <motion.div initial={{opacity:0,y:10}} animate={{opacity:1,y:0}} transition={{delay:0.35}}>
            ...
            <p style={{
              ...
              AI/ML Engineer · Generative AI &nbsp;·&nbsp; Hyderabad, India
            </p>
          </motion.div>
          ...
          <motion.div initial={{opacity:0,y:8}} animate={{opacity:1,y:0}} transition={{delay:0.7}}
            ...
            {[
              {v:"~90%",l:"Irrigation Accuracy"},
              {v:"~82%",l:"Placement Accuracy"},
              {v:"4",l:"AI Projects"},
              {v:"34K+",l:"AI Tryouts Followers"},
            ].map((s,i) => (
          ...
          <motion.div initial={{opacity:0}} animate={{opacity:1}} transition={{delay:1}}
            ...
            {[
              ...
              {icon:"in", label:"LinkedIn", href:"https://www.linkedin.com/in/nitesh-gudipatoju"},
