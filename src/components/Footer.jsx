        ...
        <motion.div
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div style={{ display: "flex", gap: 8 }}>
              {[
                ...
                { label: "in", href: "https://www.linkedin.com/in/nitesh-gudipatoju", title: "LinkedIn" },
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {[
                ...
                { label: "JobPilot", href: "https://github.com/nithu0035/jobpilot.git" },
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              <a href="https://www.linkedin.com/in/nitesh-gudipatoju" target="_blank" rel="noopener noreferrer"
                style={{
                  fontFamily: "'Inter', sans-serif", fontSize: 13,
                  color: "#475569", textDecoration: "none",
